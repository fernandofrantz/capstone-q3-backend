...
from app.controllers.purchases_controller import create_purchase, delete_purchase, get_purchases, get_purchase_by_id, patch_purchase
...
bp_purchase.patch('<int:purchase_id>')(patch_purchase)
